...
!(function (t, e) {
  ...
  return (() => {
    ...
    function w(t) {
      ...
      t: for (const i in e) {
        ...
        switch (i) {
          ...
          case "rgba": {
            const [, , , t, e, r, a] = o(n);
            if (t > 255 || e > 255 || r > 255 || a < 0 || a > 1 || !s(a))
              break t;
            return { values: [...b(t, e, r), a], a, type: i };
          }
          case "hexa": {
            let [, t] = n;
            ...
            return (
              ...
              { values: [..._(e), o], a: o, type: i }
            );
          }
          case "hsla": {
            const [, , , t, e, r, a] = o(n);
            if (t > 360 || e > 100 || r > 100 || a < 0 || a > 1 || !s(a))
              break t;
            return { values: [...g(t, e, r), a], a, type: i };
          }
          case "hsva": {
            const [, , , t, e, r, a] = o(n);
            if (t > 360 || e > 100 || r > 100 || a < 0 || a > 1 || !s(a))
    ...
    function $(t) {
      const e = {
            ...
            if (document.activeElement === o.wrapper) {
              ...
              if ("keydown" === n && (s || r || a || l)) {
                ...
                "v" === o
                  ...
                  e.update(C(e.cache.x + 0.01 * n), C(e.cache.y + 0.01 * i)),
                  t.preventDefault();
              } else
                i.startsWith("Arrow") &&
          ...
          _tapmove(t) {
            ...
            "h" !== i &&
              (s.style.left = `calc(${(l / a.width) * 100}% - ${
                s.offsetWidth / 2
              }px)`),
              "v" !== i &&
                (s.style.top = `calc(${(c / a.height) * 100}% - ${
                  s.offsetHeight / 2
                }px)`),
    ...
    class L {
      constructor(t) {
        E(this, "_initializingActive", !0),
          E(this, "_recalc", !0),
          E(this, "_nanopop", null),
          E(this, "_root", null),
          E(this, "_color", A()),
          E(this, "_lastColor", A()),
          E(this, "_swatchColors", []),
          E(this, "_setupAnimationFrame", null),
          E(this, "_eventListener", {
            init: [],
            save: [],
            hide: [],
            show: [],
          ...
          (this.options = t = Object.assign({ ...L.DEFAULT_OPTIONS }, t));
        const {
          swatches: e,
          components: o,
          theme: n,
      ...
      _clearColor(t = !1) {
        ...
        o.useAsButton ||
          e.button.style.setProperty("--pcr-color", "rgba(0, 0, 0, 0.15)"),
      ...
      setColor(t, e = !1) {
        ...
        if (o) {
          ...
          if (s && !s.hidden)
            for (const t of i)
              t.classList[t === s ? "add" : "remove"]("active");
